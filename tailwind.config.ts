  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-energetic": "linear-gradient(135deg, #3B82F6 0%, #9333EA 50%, #06B6D4 100%)",
        "gradient-agentic": "linear-gradient(135deg, #6B21A8 0%, #D946EF 100%)",
